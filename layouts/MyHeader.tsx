...
const MyHeader = memo(({ sticky }: Props) => {
  ...
  return (
    <Header
      height={110}
      sx={{ position: sticky ? 'sticky' : 'relative', top: 0 }}
    >
      <MyComp>
        <Group position='apart' style={{ height: 110 }} align='center'>
